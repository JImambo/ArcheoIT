...
// Gestion du mois à afficher (mois/année)
$year = isset($_GET['year']) ? (int)$_GET['year'] : (int)date('Y');
$month = isset($_GET['month']) ? (int)$_GET['month'] : (int)date('m');

$firstDayOfMonth = strtotime("$year-$month-01");
$daysInMonth = date('t', $firstDayOfMonth);
$startDayOfWeek = date('N', $firstDayOfMonth); // 1 = lundi ... 7 = dimanche

// Récupérer chantiers du mois affiché
...
// Construire un tableau indexé par jour avec les chantiers
$daysChantiers = [];
